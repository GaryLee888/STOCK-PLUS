...
class DayTradeWorker:
    ...
    def create_card(self, item):
        ...
        try:
            ...
            f_small = ImageFont.truetype(font_p, 18) if font_p else ImageFont.load_default()
        except:
        ...
        draw.text((40, 362), f"訊號: {item['cond']} | 偵測時間: {item['時間']}", fill=(255, 215, 0), font=f_small)
                        ...
                        if hits >= h_thr:
                            ...
                            if not last_r or (now - last_r > timedelta(minutes=45)):
                                item = {
                                    ...
                                    "sl": round(s.close * 0.985, 2), "cond": "💎 強勢突破", "hit": hits
                                }
                                # 存入結果清單
